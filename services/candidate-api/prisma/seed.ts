...
async function main() {
  ...
  await prisma.application.create({
    data: {
      ...
      motivation:
        'I am excited about this opportunity and believe I am a great fit for the role.',
  ...
  await prisma.application.create({
    data: {
      ...
      motivation:
        'I have relevant experience and skills for this position. Looking forward to the opportunity!',
      cv: 'Sample CV content...',
  ...
  await prisma.application.create({
    data: {
      ...
      motivation:
        'Although I am interested in this role, I understand if there are more suitable candidates. Thank you for considering my application.',
      cv: 'Sample CV content...',
